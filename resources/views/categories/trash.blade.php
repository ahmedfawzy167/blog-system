...
@section('content')
    <div class="row">
            <div class="table-responsive">
                <h1 class="text-center bg-dark text-light mt-3"><i class="fas fa-trash"></i> {{__('admin.Trashed Categories')}}</h1>
                    ...
                    <tbody>
                       ...
                       @foreach($trashedCategories as $category)
                        <tr>
                            <td>{{$category->id}}</td>
                            <td>{{$category->name}}</td>
                            <td><img src="{{asset('storage/'.$category->image)}}" height="100"></td>
                            <td>
